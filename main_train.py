...
#    H_img = 161
    ...
    with tf.Session() as sess:
        ...
        for i in range(epochs):
            ...
            if i % 10 ==0:
                saver.save(sess,"model/YS_huaban_train5/model.ckpt")
                print("model saved")
...
def main():
    path_train = '/home/huawei/Kyaoshi/HuaBan/Logo_train5.tfrecords' #"/home/huawei/myfile/code_python/Feng/dataset_tfrecord/Lan_HUAWEI/LOGO_train_Lan_HUAWEI_OK.tfrecords"
    path_postive = '/home/huawei/Kyaoshi/MHA_Hui_0926_ROI/Model/Logo_test5.tfrecords'
